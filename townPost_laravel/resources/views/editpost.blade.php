    ...
    @method('PUT')
        ...
        <div class="card-body">
            <div class="card mb-4">
                ...
                <input type="text" class="form-control" id="titlepage" name="title" placeholder="Enter your title here" value="{{$post->title}}">
            </div>
            </div>
            <div class="card mb-4">
                    <label class="content"><strong>Content:</strong></label>
                    <textarea class="form-control" aria-label="With textarea" name="content" value="{{$post->content}}"></textarea>
            </div>
                    <a class="btn btn-primary btn-sm" href="{{ route('retrievePost') }}"><i class="fa fa-arrow-left"></i> Back</a>
