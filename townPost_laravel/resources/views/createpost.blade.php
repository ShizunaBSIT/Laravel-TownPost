...
<main class="container mt-4">
    <form>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="example: TIP ranks firsts for International Hackathon">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="postId">Category ID</label>
                <select class="form-control" id="post">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" placeholder="example:shimshimi">
        </div>
        <div class="form-group">
